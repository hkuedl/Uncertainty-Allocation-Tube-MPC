...
class RobustMPC:
    ...
    def solve(
        ...
        """Solve the robust MPC benchmark."""
        import cvxpy as cp
        ...
        constraints.append(ess_hat <= params.ess_max - spare * (params.ess_max - params.ess_min))
        constraints.append(ess_hat >= params.ess_min + spare * (params.ess_max - params.ess_min))
        ...
        tau_range = params.tau_max[t0 : t0 + horizon] - params.tau_min[t0 : t0 + horizon]
        constraints.append(tau_hat <= params.tau_max[t0 : t0 + horizon] - spare * tau_range)
        constraints.append(tau_hat >= params.tau_min[t0 : t0 + horizon] + spare * tau_range)
